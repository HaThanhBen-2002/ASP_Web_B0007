...
CREATE TABLE chiTietHoaDonSanPham (
    ...
    donVi NVARCHAR(50),
    soLuong NVARCHAR(10),
    thanhTien NVARCHAR(10),
    FOREIGN KEY (maPhieu) REFERENCES PhieuHoaDon(maPhieu),
	FOREIGN KEY (maSanPham) REFERENCES SanPham(maSanPham)
);
CREATE TABLE chiTietHoaDonNhanVien (
    maPhieu INT NOT NULL,
...
CREATE TABLE chiTietHoaDonDichVu (
    maPhieu INT NOT NULL,
	maSuDungDichVu INT NOT NULL,
    tenChiTiet NVARCHAR(255),
    donVi NVARCHAR(50),
    soLuong NVARCHAR(10),
    thanhTien NVARCHAR(10),
    FOREIGN KEY (maPhieu) REFERENCES PhieuHoaDon(maPhieu),
	FOREIGN KEY (maSuDungDichVu) REFERENCES SuDungDichVu(maSuDungDichVu)
);
