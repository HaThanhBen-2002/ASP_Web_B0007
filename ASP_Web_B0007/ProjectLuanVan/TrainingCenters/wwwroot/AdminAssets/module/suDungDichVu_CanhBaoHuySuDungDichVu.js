        ...
        if (selectedIds.length >= 1) {
            for (let itemId of selectedIds) {
                ...
                if (suDungDichVu != null) {
                    ...
                    let tieuDe = "Thông báo " + hocSinh.tenHocSinh + " cảnh báo hủy dịch vụ " + dichVu.tenDichVu;
                    var emailContent = `
                        <div class="content">
                            <p>Xin chào Phụ huynh <strong>`+ hocSinh.tenHocSinh + ` </strong>,</p>
                            <p> Chúng tôi xin nhắc nhở bạn về việc hủy sử dụng dịch vụ <strong>`+ dichVu.tenDichVu + `</strong> đã hết hạn vào ngày ` + suDungDichVu.ngayKetThuc +`</p>
                            <table>
                                <tr>
                            ...
                            <p>Vui lòng gia hạn dịch vụ để tránh bị hủy dịch vụ.</p>
